    ...
    function Chat() {
        ...
        this.inputElement.on('keypress', function (evt) {
            if (evt.charCode === 13) {
                ...
                _this.chatListener(value);
                $(_this).val('');
            }
        });

        $('.chat-submit').on('click', function () {
            var value = _this.inputElement.val();
            _this.chatListener(value);
            _this.inputElement.val('');
        });
    }

    _createClass(Chat, [{
        key: 'newMessage',
        value: function newMessage(msg) {
            this.contentElement.append('<li>' + msg + '</li>');
        }
    }, {
        key: 'setChatListener',
        value: function setChatListener(func) {
...
var _vector2Node = require('vector2-node');

var _vector2Node2 = _interopRequireDefault(_vector2Node);
...
var Client = (function () {
    function Client() {
        ...
        this.socket = _socketIoClient2['default'].connect('http://localhost:8888', {
            'reconnect': false
        });
        ...
        this.socket.on('playerName', function (data) {
            ...
            try {
                ...
                for (var _iterator = _this.entities[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        this.socket.on('updateEntity', function (entityData) {
            ...
            updatedEntity.setPos(new _vector2Node2['default'](entityData.x, entityData.y));
            ...
            mesh.forEach(function (vertex, index) {
                var screenPos = _this.renderer.worldToScreen(vertex);
                var nextPos = _this.renderer.worldToScreen(mesh[index + 1 == mesh.length ? 0 : index + 1]);
            ...
            var vec1 = _this.renderer.worldToScreen(aabb.min);
            var vec2 = _this.renderer.worldToScreen(new _vector2Node2['default'](aabb.min.x, aabb.max.y));
            var vec3 = _this.renderer.worldToScreen(aabb.max);
            var vec4 = _this.renderer.worldToScreen(new _vector2Node2['default'](aabb.max.x, aabb.min.y));
        ...
        this.socket.on('removeEntity', function (entityId) {
            _lodash2['default'].each(_this.entities, function (entity, index) {
                if (entity.uniqueId != entityId) {
                    return;
                }

                _this.renderer.removeEntity(entity);
        ...
        this.socket.on('newEntity', function (networkEntityData) {
            var uniqueId = networkEntityData.uniqueId;
            var className = networkEntityData.className;
            var instanceData = networkEntityData.instanceData;

            _this.createEntity(className, uniqueId, instanceData);
        });

        this.socket.on('loadEntity', function (networkEntityData) {
            var uniqueId = networkEntityData.uniqueId;
            var className = networkEntityData.className;
            var instanceData = networkEntityData.instanceData;

            var entity = _this.createEntity(className, uniqueId, instanceData);

            if (networkEntityData.isLocalPlayer) {
                _this.localPlayer = entity;
                _this.localPlayer.input = new _commonInput2['default']();
            }
        });

        this.socket.on('load', function (data) {
            _this.renderer.renderWorld(data.map);
        });
        ...
        $('#game canvas').keydown(function (evt) {
            ...
            if (!_this.localPlayer || !_this.localPlayer.input) {
                return;
            }

            if (keyCode == KEY_W) {
                _this.localPlayer.input.up = 1;
            } else if (keyCode == KEY_A) {
                _this.localPlayer.input.left = 1;
            } else if (keyCode == KEY_S) {
                _this.localPlayer.input.down = 1;
            } else if (keyCode == KEY_D) {
                _this.localPlayer.input.right = 1;
            } else if (keyCode == KEY_SPACE) {
                _this.localPlayer.input.attack = 1;
            }
        });
        ...
        $('#game canvas').keyup(function (evt) {
            ...
            if (keyCode == KEY_W) {
                _this.localPlayer.input.up = 0;
            } else if (keyCode == KEY_A) {
                _this.localPlayer.input.left = 0;
            } else if (keyCode == KEY_S) {
                _this.localPlayer.input.down = 0;
            } else if (keyCode == KEY_D) {
                _this.localPlayer.input.right = 0;
            } else if (keyCode == KEY_SPACE) {
                _this.localPlayer.input.attack = 0;
            }
        });
    ...
    _createClass(Client, [{
        ...
        value: function registerModels() {
            ...
            var hash2 = {'base': require('../models/base.json'),'longblock': require('../models/longblock.json')};

            // Iterate the /entities/ folder
            _lodash2['default'].forOwn(hash2, function (loadedModel, requirePath) {

                var modelName = requirePath.replace('.json', ''),
                    rawMesh = loadedModel.mesh,
                    builtMesh = [];

                for (var i = 0; i < rawMesh.length; i += 2) {
                    builtMesh.push(new _vector2Node2['default'](rawMesh[i], rawMesh[i + 1]));
                }

                loadedModel.mesh = builtMesh;

                _this2.registeredModels[modelName] = loadedModel;
            });
        }
    }, {
        key: 'registerEntities',
        value: function registerEntities() {
            var hash = {'base/shared': require('../entities/base/shared.js'),'longblock/shared': require('../entities/longblock/shared.js'),'player/shared': require('../entities/player/shared.js')};
            var hash2 = {'base/client': require('../entities/base/client.js'),'longblock/client': require('../entities/longblock/client.js'),'player/client': require('../entities/player/client.js')};
            var rawEntities = {};
            var resolvedEntities = {};
            var resolveEntity = function resolveEntity(entityName) {
                ...
                var parentType = _lodash2['default'].clone(resolveEntity(entity.baseClass));

                return _lodash2['default'].merge(parentType, _lodash2['default'].clone(rawEntities[entityName]));
            };

            // Iterate the /entities/ folder
            _lodash2['default'].forOwn(hash2, function (entityObject, requirePath) {
            ...
            _lodash2['default'].forOwn(rawEntities, function (entity, entityName) {
        ...
        key: 'getEntityById',
        value: function getEntityById(uniqueId) {
        ...
        key: 'createEntity',
        value: function createEntity(entityClass, uniqueId, instanceData) {
            var _this3 = this;

            var Entity = function Entity() {};
            var entityPrototype = this.registeredEntities[entityClass];
            var createdEntity = undefined;
            var opts = {
                font: 'Arial',
                size: 16,
                strokeSize: 2,
            ...
            mesh.forEach(function (vertex, index) {
                var screenPos = _this3.renderer.worldToScreen(vertex);
                var nextPos = _this3.renderer.worldToScreen(mesh[index + 1 == mesh.length ? 0 : index + 1]);
            ...
            var vec2 = this.renderer.worldToScreen(new _vector2Node2['default'](aabb.min.x, aabb.max.y));
            var vec3 = this.renderer.worldToScreen(aabb.max);
            var vec4 = this.renderer.worldToScreen(new _vector2Node2['default'](aabb.max.x, aabb.min.y));
            ...
            var model = this.registeredModels[instanceData.model];
        ...
        value: function tick() {
            ...
            var cameraPos = new _vector2Node2['default'](0, 0);
            ...
            if (this.localPlayer) {
                ...
                var aimVec = new _vector2Node2['default'](mouseWorldPos.x - playerPos.x, mouseWorldPos.y - playerPos.y).normalize();
...
},{"../common/input":6,"../entities/base/client.js":8,"../entities/base/shared.js":9,"../entities/longblock/client.js":10,"../entities/longblock/shared.js":11,"../entities/player/client.js":12,"../entities/player/shared.js":13,"../models/base.json":14,"../models/longblock.json":15,"./../common/constants":5,"./chat":1,"./renderer":4,"lodash":16,"socket.io-client":17,"vector2-node":67}],3:[function(require,module,exports){
"use strict";
...
var Renderer = (function () {
    ...
    _createClass(Renderer, [{
        ...
        key: 'createText',
        value: function createText(str, opts, parent) {
            opts = opts || {
                size: 16,
                font: 'Arial',
                stroke: 0,
        ...
        key: 'getMouseWorldPos',
        value: function getMouseWorldPos() {
        ...
        key: 'worldToScreen',
        value: function worldToScreen(vec) {
            return new Vec2(-vec.x * this.unitPixelSize, vec.y * this.unitPixelSize);
        }
    }, {
        key: 'renderWorld',
        value: function renderWorld(data) {
            var _this = this;

            var middle = data.length / 2;
            data.forEach(function (row, y) {
                row.forEach(function (value, x) {
                    var xCenter = (x - middle) * _this.unitPixelSize;
                    var yCenter = (y - middle) * _this.unitPixelSize;
                    ...
                    entityRenderable.drawRect(0, 0, _this.unitPixelSize, _this.unitPixelSize);
                    entityRenderable.endFill();

                    entityRenderable.position.x = xCenter;
                    entityRenderable.position.y = yCenter;

                    _this.mapLayer.addChild(entityRenderable);

                    _this.mapData.push(entityRenderable);
                });
            });
        }
    }, {
        key: 'render',
        value: function render(cameraPos) {
...
},{"vector2-node":67}],5:[function(require,module,exports){
"use strict";
...
var PhysicsState = (function () {
    function PhysicsState() {
        ...
        var defaultMesh = [new Vec2(-0.5, 0.5), new Vec2(0.5, 0.5), new Vec2(0.5, -0.5), new Vec2(-0.5, -0.5)];
    ...
    _createClass(PhysicsState, [{
        ...
        value: function clone() {
            ...
            _.each(this.mesh, function (vertex) {
        ...
        key: 'setMass',
        value: function setMass(newMass) {
            this.mass = newMass;
        ...
        value: function getMesh() {
            ...
            this.vertices.forEach(function (vertex) {
                ...
                vert.rotate(_this.angle);
                vert = vert.add(_this.position);
...
},{"lodash":16,"vector2-node":67}],8:[function(require,module,exports){
'use strict';
...
var BaseClientEntity = _.merge(BaseSharedEntity, {
    ...
    setTexture: function setTexture(texturePath) {
...
},{"./shared":9,"lodash":16}],9:[function(require,module,exports){
'use strict';
...
var _commonPhysicsState = require('./../../common/physicsState');

var _commonPhysicsState2 = _interopRequireDefault(_commonPhysicsState);

var BaseEntity = {
    uniqueId: 0,
    isBeingRemoved: 0,
    modelName: 'base',
    physicsType: _commonConstants2['default'].PHYSICS_TYPE_SIMULATE,
    appliedForce: null,
    appliedTorque: null,
    physicsState: null,
    ...
    _internalInit: function _internalInit() {
        this.appliedForce = new _vector2Node2['default'](0, 0);
        this.appliedTorque = new _vector2Node2['default'](0, 0);
        this.physicsState = new _commonPhysicsState2['default']();
        this.lastPhysicsState = new _commonPhysicsState2['default']();
    },
    init: function init() {},
    shouldRemove: function shouldRemove(bool) {
        this.isBeingRemoved = bool;
    },

    applyImpulse: function applyImpulse(impulse, offset) {
    ...
    getLocalMesh: function getLocalMesh() {
    ...
    getPhysicsType: function getPhysicsType() {
        return this.physicsType;
    },

    getAppliedForce: function getAppliedForce() {
        return this.appliedForce;
    },

    getAppliedTorque: function getAppliedTorque() {
        return this.appliedTorque;
    },

    physicsSimulate: function physicsSimulate() {
        return new _vector2Node2['default'](0, 0);
    },
    ...
    getLocalAABB: function getLocalAABB() {
        return {
            min: this.physicsState.aabbMin,
            max: this.physicsState.aabbMax
        };
    },
    getPhysicsState: function getPhysicsState() {
        return this.physicsState;
    },

    getLastPhysicsState: function getLastPhysicsState() {
        return this.lastPhysicsState;
    },

    clearAppliedForce: function clearAppliedForce() {
        this.appliedForce.x = 0;
        this.appliedForce.y = 0;
    },

    clearAppliedTorque: function clearAppliedTorque() {
...
},{"./../../common/constants":5,"./../../common/physicsState":7,"vector2-node":67}],10:[function(require,module,exports){
'use strict';
...
},{"./shared":11,"lodash":16}],11:[function(require,module,exports){
'use strict';
...
var LongBlockShared = _.merge(BaseSharedEntity, {
    baseClass: "base",
    init: function init() {
        this.physicsState.vertices = [new Vec2(-0.5, 1.5), new Vec2(0.5, 1.5), new Vec2(0.5, -1.5), new Vec2(-0.5, -1.5)];
    }
});

module.exports = LongBlockShared;

},{"./../base/shared":9,"lodash":16,"vector2-node":67}],12:[function(require,module,exports){
'use strict';

var _ = require('lodash');
var SharedPlayer = _.clone(require('./shared'));

var ClientPlayer = _.merge(SharedPlayer, {});

module.exports = ClientPlayer;

},{"./shared":13,"lodash":16}],13:[function(require,module,exports){
'use strict';
...
var Player = {
    ...
    getAimVector: function getAimVector() {
...
},{"./../../common/input":6,"vector2-node":67}],14:[function(require,module,exports){
module.exports={
  "texture": "box.jpg",
  "mesh": [-0.5,0.5,0.5,0.5,0.5,-0.5,-0.5,-0.5]
}

},{}],15:[function(require,module,exports){
module.exports={
  "texture": "longbox.png",
  "mesh": [-0.5,1,0.5,1,0.5,-1,-0.5,-1]
}
...
},{"./manager":19,"./socket":21,"./url":22,"debug":26,"socket.io-parser":62}],19:[function(require,module,exports){
...
},{"./on":20,"./socket":21,"./url":22,"backo2":23,"component-bind":24,"component-emitter":25,"debug":26,"engine.io-client":27,"indexof":58,"object-component":59,"socket.io-parser":62}],20:[function(require,module,exports){
...
},{"./on":20,"component-bind":24,"component-emitter":25,"debug":26,"has-binary":56,"socket.io-parser":62,"to-array":66}],22:[function(require,module,exports){
(function (global){
...
},{"debug":26,"parseuri":60}],23:[function(require,module,exports){
...
},{"./socket":29,"engine.io-parser":41}],29:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"./transport":30,"./transports":31,"component-emitter":25,"debug":38,"engine.io-parser":41,"indexof":58,"parsejson":52,"parseqs":53,"parseuri":54}],30:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":25,"engine.io-parser":41}],31:[function(require,module,exports){
(function (global){
/**
 * Module dependencies
 */
...
},{"./polling":34,"component-emitter":25,"component-inherit":37,"debug":38,"xmlhttprequest":36}],34:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":30,"component-inherit":37,"debug":38,"engine.io-parser":41,"parseqs":53,"xmlhttprequest":36}],35:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":30,"component-inherit":37,"debug":38,"engine.io-parser":41,"parseqs":53,"ws":55}],36:[function(require,module,exports){
...
},{"has-cors":50}],37:[function(require,module,exports){
...
},{"./keys":42,"after":43,"arraybuffer.slice":44,"base64-arraybuffer":45,"blob":46,"has-binary":47,"utf8":49}],42:[function(require,module,exports){
...
},{"global":51}],51:[function(require,module,exports){
...
},{"dup":48}],58:[function(require,module,exports){
...
},{"./binary":61,"./is-buffer":63,"component-emitter":25,"debug":26,"isarray":64,"json3":65}],63:[function(require,module,exports){
(function (global){
...
arguments[4][48][0].apply(exports,arguments)
},{"dup":48}],65:[function(require,module,exports){
